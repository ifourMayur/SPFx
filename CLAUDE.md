...
- Colours go through SPFx theme tokens (`"[theme:neutralLight, default: #e3e6ea]"`) rather than literals. `*.scss.ts` typings are generated by the sass task and gitignored — never hand-edit or commit them.
